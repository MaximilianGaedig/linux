...
static int phy_init_seq[] = {0x38, 0x81, /* update DC voltage level */
                             0x24,
                             0x82, /* set pre-emphasis and rise/fall time */
                             -1};
...
static ssize_t tma340_vkeys_show(struct kobject *kobj,
  ...
  return snprintf(
      ...
      __stringify(EV_KEY) ":" __stringify(
          KEY_BACK) ":73:1120:97:97"
                    ":" __stringify(EV_KEY) ":" __stringify(
                        KEY_MENU) ":230:1120:97:97"
                                  ":" __stringify(EV_KEY) ":" __stringify(
                                      KEY_HOME) ":389:1120:97:97"
                                                ":" __stringify(EV_KEY) ":" __stringify(
                                                    KEY_SEARCH) ":544:1120:97:"
                                                                "97"
                                                                "\n");
}
...
static struct attribute *tma340_properties_attrs[] = {&tma340_vkeys_attr.attr,
                                                      NULL};
...
static int cyttsp_platform_init(struct i2c_client *client) {
  ...
  tma340_properties_kobj = kobject_create_and_add("board_properties", NULL);
...
static struct platform_device *cdp_devices[] __initdata = {
    &apq8064_device_uart_gsbi1, &apq8064_device_uart_gsbi7,
...
MACHINE_START(APQ8064_CDP, "QCT APQ8064 CDP")
   ...
   .init_very_early = apq8064_early_reserve, .restart = msm_restart,
   MACHINE_END
   ...
   .init_machine = apq8064_cdp_init,
   .init_early = apq8064_allocate_memory_regions,
   .init_very_early = apq8064_early_reserve, .restart = msm_restart, MACHINE_END
