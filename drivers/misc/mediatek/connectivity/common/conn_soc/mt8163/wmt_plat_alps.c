...
/* Modern mainline: wakeup_source_register()/_unregister(), pointer-based. */
...
#ifdef CONFIG_OF
			/*
			 * wmt_plat_alps.c was ported from an mt7623 consys
			 * driver - this was still searching for that SoC's
			 * compatible string instead of biscuit's actual
			 * "mediatek,mt8163-consys" (see mt8163.dtsi), so
			 * of_find_compatible_node() always came back NULL.
			 */
